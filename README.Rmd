...
To share all source code in a single plain text file, you can use the provided consolidation scripts:
...
# Or using R
Rscript generate_code_text.R
```

This will generate `all_code.txt` containing all R and C++ source files. See [CODE_SHARING.md](CODE_SHARING.md) for more details.
